...
export const MenuCard = async () => {
  ...
  return (
    <div
      id="menucard"
      className="w-full min-h-[100vh] lg:w-[50vw] p-2 md:px-24 md:py-12 border-none shadow-black shadow-lg rounded-lg bg-white bg-opacity-[90%] z-0 cursor-default tracking-widest"
    >
